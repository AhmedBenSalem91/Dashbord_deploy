<template>
  ...
  <CTable v-else caption="top" striped>
    <CTableCaption>
      ...
      <CButton color="primary" size="sm" class="add-home-btn" @click="redirectToUpdateCover">
        Modifier
      </CButton>
    </CTableCaption>
    <CTableHead>
      <CTableRow>
        ...
        <CTableHeaderCell scope="col">Hero</CTableHeaderCell>
      </CTableRow>
    </CTableHead>
    <CTableBody v-if="home">
      <CTableRow>
        <CTableDataCell style="width: 50%;">{{ home.title }}</CTableDataCell>
        <CTableDataCell>
          <img style="height: auto; width: 100%;" :src=" domains + `/uploads/home/${home.hero}`" alt="hero" />
        </CTableDataCell>
      </CTableRow>
    </CTableBody>
  </CTable>
...
// Redirect function
const redirectToUpdateCover = () => {
  router.push('/home-page-management/update-cover')
}
